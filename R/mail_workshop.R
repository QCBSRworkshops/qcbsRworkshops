...
#' @param lang the langage of the mail by default the mail written
#'
#' @details
...
Thanks, and looking forward to Friday!\n\n", pres_name, "\n")
  ...
  blastula::compose_email(
    ...
    footer = blastula::md("Mail generated using the [blastula package](https://github.com/rich-iannone/blastula)")
  )
